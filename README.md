...
I have added support for running the code in a Docker container.

```
.\build.ps1
.\run.ps1
docker exec -it faceswap bash
/home/ubuntu# sh download_models.sh
/home/ubuntu# python3 main.py --face examples/images/elon_musk.jpg --body examples/images/murakami.jpg
```
